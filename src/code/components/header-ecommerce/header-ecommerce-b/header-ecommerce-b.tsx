...
import styles from "./header-ecommerce-b.module.css";
...
export default function HeaderEcommerceB({
  className,
  rounded,
  variant = "default",
}: Props) {
  ...
  return (
    ...
    >
      ...
      <nav className={clsx(styles["navbar"], styles["navbar-2"])}>
        <div className={styles["navbar-content"]}>
          <div className={clsx(styles["nav-start"])}></div>

          {/* Navigation at center */}
          <div className={clsx(styles["nav-middle"])}>
      ...
      <nav className={clsx(styles["navbar"], styles["navbar-3"])}>
        <div className={styles["navbar-content"]}>
                ...
                <div>
                  <div className={styles["s-desc"]}>
                    <img
                      ...
                      alt="image"
                    />
                    <p>This is a sample submenu content which uses CSS.</p>
                  </div>
                </div>
              </div>
            </div>
