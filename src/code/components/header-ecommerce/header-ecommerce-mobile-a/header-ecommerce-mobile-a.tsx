import { Bars2Icon, MagnifyingGlassIcon, ShoppingBagIcon } from "@heroicons/react/24/outline";
import clsx from "clsx";
import styles from "./header-ecommerce-mobile-a.module.css";

type Props = {
  className?: string;
};

export default function HeaderEcommerceMobileA({
  className
}: Props) {
