...
import NavScreenA from "./nav-screen-ecommerce-a";
  ...
  return (
    <div className="mx-auto flex justify-center gap-8">
      <div style={{ width: "380px" , height: "640px"}}>
        <NavScreenA
          headerLeftElement={"LOGO"}
          headerRightElement={<XMarkIcon className="w-6" />}
          defaultActive="home"
          navigationItems={[
            { title: "Collection", slug: "collection"  },
            { title: "Woman", slug: "woman" },
            { title: "Man", slug: "man" },
            { title: "Girl", slug: "girl" },
            { title: "Boy", slug: "boy" },
            { title: "Baby", slug: "baby" }, 
          ]}
          footerLeftElement={"Designed by us"}
          footerRightElement={"Tw. Ig. Tk."}
        />
      </div>
    </div>
  );
