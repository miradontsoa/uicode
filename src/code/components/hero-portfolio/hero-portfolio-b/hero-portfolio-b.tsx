...
import styles from "./hero-portfolio-b.module.css";
...
export default function HeroPortfolioB({
  className,
  variant = "default",
}: Props) {
  return (
      ...
      <div className={styles["bg-image"]}>
        <picture>
          <source
            ...
            srcSet="/placeholder/img-ecommerce-1-large.jpg"
          />
          <img
            className={styles["image"]}
            src="/placeholder/img-ecommerce-1-mobile.jpg"
